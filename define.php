...
$vLang = (empty($_SESSION["language"])) ? 'vi' : $_SESSION["language"];
...
define('TTH_PATH_LK', '/?ol='); // Variable
define('TTH_PATH_OP', 'op'); // Variable
define('TTH_PATH_OP_LK', '&op='); // Variable
//define('FILE_MAX_SIZE', 2097152);
define('MAX_EXECUTION_TIME', 0);
//maximum orders would be 999999
define('MAX_ORDER' , '000000');
// Database info
...
/** Temps Path */
define("_F_TEMPLATES", _F_MODULES . DS . "_temp");
define("_A_TEMPLATES", _A_MODULES . DS . "_temp");
/** Actions Path */
define("_F_ACTIONS", _F_MODULES . DS . "_action");
define("_A_ACTIONS", _A_MODULES . DS . "_action");
