...
if($emailToBackup=="") {
	...
	if($send_mail == TRUE)
		echo "<script>alert('Tiến trình sao lưu cơ sở dữ liệu và gửi file đến e-mail đều thành công.')</script>";
	else
		echo "<script>alert('Tiến trình sao lưu cơ sở dữ liệu đã thành công nhưng gửi file đến e-mail thất bại.')</script>";
}
