...
if(isset($_POST['id'])) {
	...
	foreach($rows as $row) {
		...
		<div class="modal-dialog">
			...
			<span class="namehoadon" style="">THEO DÕI THANH TOÁN ĐƠN HÀNG</span><br>
			...
			<input style="width: 100%;max-width: 100%;" class="form-control tienconlai "  disabled=""  value="<?=number_format(stripcslashes($row['debtor']),0,',','.');?>" / > 
			<span style="position: absolute; right: 5px;top: 5px;">VNĐ</span>
			</div>
			</div>
		...
		function handleForm() {
			...
			return add_payment('_form_payment');
			
			}
			else alert('Thay &#273;&#7893;i thanh to�n &#273;&#417;n h�ng kh�ng h&#7907;p l&#7879;');
