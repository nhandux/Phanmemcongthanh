        ...
        <div>
				<div class="row addselect">
					<div class="col-md-2 col-sm-4 col-xs-12">
                     <div class="xulyselect">
						<input type="text"   class="nhanselect  nhanselect1 form-control sanphamtype" onclick="chonse(this,'locselect')" onkeyup="chonselect1('nhanselect','locselect')" placeholder="Chọn sản phẩm... " title="chọn sản phẩm..." autocomplete="off">
                        <span class="caret caretcustumnhan" ></span>
						<ul class="locselect locselect1">
						<?=getListOfProducts();?>	
						</ul>
                       </div>
					</div>
					<div class="col-md-2 col-sm-4 col-xs-12">
                        <div class="xulyselect">
						<input type="text"  class="nhanselect nhanselect1 form-control sanphamsize1" onclick="chonse(this,'locselect')" onkeyup="chonselect1('nhanselect','locselect')" placeholder="Chọn kích thước... " title="chọn kích thước..." autocomplete="off">
                        <span class="caret caretcustumnhan" ></span>
						<ul class="locselect locselect1">
...
$('.locselect1 li a').on('click', function(event) {
	...
	if(productData)
		$(this).parent().parent().siblings('.nhanselect1').data('product', productData)
	if(collection)
			$(this).parent().parent().siblings('.nhanselect1').data('collection', collection)
	$(this).parent().parent().siblings('.nhanselect1').val(gtsl)
	$(this).parent().parent().find('a').removeClass('activeslect')
	$(this).addClass('activeslect')
	
	
});
$('#bangdanhsachmonhang').on('click', '.locselect1 li a'  ,function(event) {
...
$(document).click(function(event) { 
if(!$(event.target).closest('#locselectoption').length && !$(event.target).is('.tencongty')) {
        if($('#locselectoption').is(":visible")) {
            $('#locselectoption').hide();
        }
    }  

});
$(document).click(function(event) { 
if(!$(event.target).closest('#locoption').length && !$(event.target).is('.namenguoidat')) {
        if($('#locoption').is(":visible")) {
            $('#locoption').hide();
        }
    }  
...
$('#khachtochuc').addClass('active12');
 ...
 $('#themmonhang').click(function(e) {
	 ...
	 var list_product = [];
		...
		for(var j = 0; j < list_product.length; j++) {
			...
			var productSelect = '<div class="xulyselect">'+
						'<input type="text"  value="'+list_product[j]['sp']+'" class="nhanselect nhanselect1 form-control fixproduct " onclick="chonse(this,\'locselect1\')" onkeyup="chonselect1(\'nhanselect1\',\'locselect1\')" placeholder="Chọn sản phẩm... " title="chọn sản phẩm..." autocomplete="off">'+
	 ...
	 var sizeSelect = '<div class="xulyselect">'+
						'<input type="text" value="'+list_product[j]['size']+'" class="nhanselect nhanselect1 form-control fixsize " onclick="chonse(this,\'locselect1\')" onkeyup="chonselect1(\'nhanselect1\',\'locselect1\')" placeholder="Chọn kích thước... " title="chọn kích thước..." autocomplete="off">'+
                        '<span class="caret caretcustumnhan" style="top:12px"></span>'+
						'<ul class="locselect locselect1">'+
						'<li><a href="javascript:{0}" value="4A0">4A0</a></li>'+
						 '<li><a href="javascript:{0}" value="2A0">2A0</a></li>'+
	 ...
	 var unit = ($('.laygiatritep').val() !== '')? ('/' + $('.laygiatritep').val()): '/Cái' ;
	  ...
	  var productSelect = '<div class="xulyselect">'+
						'<input type="text"  value="'+sanpham+'" class="nhanselect nhanselect1 form-control fixproduct " onclick="chonse(this,\'locselect1\')" onkeyup="chonselect1(\'nhanselect1\',\'locselect1\')" placeholder="Chọn sản phẩm... " title="chọn sản phẩm..." autocomplete="off">'+
                        '<span class="caret caretcustumnhan" style="top:12px" ></span>'+
						'<ul  class="locselect locselect1">'+
							list_products +
						'</ul>'+
                      '</div>'; 
	 var sizeSelect = '<div class="xulyselect">'+
						'<input type="text" value="'+size+'" class="nhanselect form-control nhanselect1 fixsize " onclick="chonse(this,\'locselect1\')" onkeyup="chonselect1(\'nhanselect1\',\'locselect1\')" placeholder="Chọn kích thước... " title="chọn kích thước..." autocomplete="off">'+
                        '<span class="caret caretcustumnhan" style="top:12px"></span>'+
						'<ul  class="locselect locselect1">'+
						'<li><a href="javascript:{0}" value="4A0">4A0</a></li>'+
						 '<li><a href="javascript:{0}" value="2A0">2A0</a></li>'+
...
function validateF() {
  ...
  if (!kiemtramail.test(email)){
   return false;
	...
	if( email = '' ||  sodienthoai === '' || namenguoidat === '') {
		return false; }
