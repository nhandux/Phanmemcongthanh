...
//
function jobs_addressGeneral($act, $typeFunc, $jobs_address_id, $title, $slug, $is_active, $error) {
	...
	<div class="col-lg-7 col-md-10">
		<div class="panel">
			<div class="panel-heading">
				<i class="fa fa-gear fa-fw"></i> Nội dung địa điểm
			...
			<div class="panel-body">
				<div class="form-responsive">
					<form action="<?php echo $act?>" method="post" class="form-xs-10">
						...
						<input type="hidden" name="jobs_address_id" value="<?php echo $jobs_address_id?>" />
						...
						<table class="table table-no-border table-hover">
							...
							<tr>
								<td colspan="2" class="form-ol-btn-tzc">
									...
									<button type="button" class="btn btn-danger" onclick="location.href='<?php echo TTH_PATH_LK . $link_ol[4] . TTH_PATH_OP_LK . $link_op[4][4];?>'">Thoát</button>
								</td>
							</tr>
						</table>
					</form>
