						...
						<tbody class="taplet">
							<tr class="bangkhachhang">
								...
								<select name="tech" class="tech form-control sectcustum1" id="tech" style="padding-left: 20px;">
							      <option value="cd" data-image="<?= HOME_URL;?>/images/xanh.png" name="cd" selected="selected">Đang in</option>
							      <option value="email"  data-image="<?= HOME_URL;?>/images/hong.png" disabled="disabled" >Đang đóng gói</option>
								  <option value="email"  data-image="<?= HOME_URL;?>/images/lacay.png" disabled="disabled" >Đang giao hàng</option>
							      <option value="faq" data-image="<?= HOME_URL;?>/images/do.png" disabled="disabled" >Chưa thanh toán</option>
							    </select>
