	...
	<div class="col-lg-12 col-md-12">
		<div class="panel">
			<div class="panel-heading">
				<i class="<?php echo $icon_ol[4];?> fa-fw"></i> <?php echo $menu_op[4][4];?>
			...
			<div class="panel-body">
				<div class="form-responsive  row chucnangsaoluu label_normal">
					<form action="<?php echo TTH_PATH_LK . $link_ol[6] . TTH_PATH_OP_LK . $link_op[6][4]?>" method="post" class="form-ol-3w">
