	...
	<div class="col-lg-12">
		<div class="panel">
			<div class="panel-heading">
				<i class="<?php echo $icon_ol[4];?> fa-fw"></i> <?php echo $menu_op[4][5];?>
			...
			<div class="panel-body">
				<div class="form-responsive">
					<form action="<?php echo TTH_PATH_LK . $link_ol[4] . TTH_PATH_OP_LK . $link_op[4][5]?>" method="post" class="form-ol-3w">
						<table class="table table-no-border table-hover">
							<tr>
								<td width="200px"><label class="form-lb-tp">Kích thước ảnh tối đa:</label></td>
								<td>
									<span>
										<input style="width: 120px; display: inline-block;" class="form-control" type="text" name="upload_img_max_w" value="<?=getConstant('upload_img_max_w')?>" >
									</span>
									<span> x </span>
									<span>
										<input style="width: 120px; display: inline-block;" class="form-control" type="text" name="upload_img_max_h" value="<?=getConstant('upload_img_max_h')?>" >
									</span> &nbsp;
									<label class="checkbox-inline">
										<input type="checkbox" name="upload_auto_resize" value="1" <?php if(getConstant('upload_auto_resize')==1) echo 'checked';?>>
									</label>
									<span>Tự động resize ảnh nếu kích thước lớn hơn kích thước tối đa.</span>
								</td>
							</tr>
							<tr>
								<td><label class="form-lb-tp">Dung lượng tối đa:</label></td>
								<td>
							...
							<tr>
								<td><label class="form-lb-tp">Kiểu kiểm tra file tải lên:</label></td>
								<td>
									<select  style="width: 120px; display: inline-block;" name="upload_checking_mode" class="form-control">
							...
							<tr>
								<td><label class="form-lb-tp">Loại files cho phép:</label></td>
								<td>
									<?php
							...
							<tr>
								<td><label class="form-lb-tp">Phần mở rộng bị cấm:</label></td>
								<td>
									<?php
							...
							<tr>
								<td><label class="form-lb-tp">Loại mime bị cấm:</label></td>
								<td>
									<?php
