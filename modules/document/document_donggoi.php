						...
						<tbody class="taplet">
							<tr class="bangkhachhang">
								...
								<select name="tech" class="tech form-control sectcustum1" id="tech" style="padding-left: 20px;">
							     <option   value="Đang đóng gói" data-image="<?= HOME_URL;?>/images/xanh.png">Đang đóng gói</option>
							      <option value="Cho giao hàng" data-image="<?= HOME_URL;?>/images/lacay.png" name="cd">Cho giao hàng</option>
							    </select>
								...
								<select  class=" form-control sectcustum3 set1">
								  ...
								  <option value="Đang đóng gói" selected="selected">Nhân</option>
								  <option value="Cho giao hàng">Hòa</option>
					...
					<table class="table table-no-border table-ol-3w table-hover">
						...
						<tbody class="taplet">
							...
							<tr class="bangkhachhang">
								...
								<select  class=" form-control sectcustum3 set1">
								  <option value="calendar">&nbsp;</option>
								  <option value="Đang đóng gói" >Nhân</option>
								  <option value="Cho giao hàng">Hòa</option>
								...
								<select  class=" form-control sectcustum3 set1">
								  <option value="calendar">&nbsp;</option>
								  <option value="Đang đóng gói">Nhân</option>
								  <option value="Cho giao hàng" selected="selected">Hòa</option>
								  <option value="email">Thức</option>
								  <option value="faq">Toàn</option>
								  <option value="email">Duyên</option>
								  <option value="faq">Hà</option>
