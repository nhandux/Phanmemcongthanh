						...
						<tbody class="taplet">
							<tr class="bangkhachhang">
								...
								<select name="tech" class="tech form-control sectcustum1" id="tech" style="padding-left: 20px;">
							      <option value="calendar" data-image="<?= HOME_URL;?>/images/cam.png">Đang thiết kế</option>
							      <option value="shopping_cart" data-image="<?= HOME_URL;?>/images/hong.png">Đang xuất kẽm</option>
							      <option value="cd" data-image="<?= HOME_URL;?>/images/xanh.png" name="cd">Đang in</option>
							      <option value="email"  data-image="<?= HOME_URL;?>/images/lacay.png">Đang giao hàng</option>
							      <option value="faq" data-image="<?= HOME_URL;?>/images/do.png">Chưa thanh toán</option>
							    </select>
							...
							<tr class="bangkhachhang">
								...
								<select name="tech" class="tech form-control sectcustum1" id="tech2" style="padding-left: 20px;">
							        <option   value="Đang thiết kế" data-image="<?= HOME_URL;?>/images/xanh.png">Đang thiết kế</option>
							      <option selected="selected" value="Cho xuất kẽm" data-image="<?= HOME_URL;?>/images/lacay.png" name="cd">Cho xuất kẽm</option>
							    </select>
