...
<div class="row">
	<!-- <div class="col-md-8">
		<ul class="breadcrumbs-alt">
		    <li><span class="themdonhang">Tình trạng đơn hàng</span></li>
	    </ul>
	</div> -->
	
<!-- test ứng dụng chụp ảnh màng hỉnh -->
...
<div class="col-md-4">
	...
	<!-- <button class="btn btn-round color-1 material-design nuthemmuc" onclick="themtrang()" style="float: right !important;" type="submit" name="login_admin" data-color="#004740" data-toggle="tooltip" data-placement="top" title="" data-original-title="Thêm đơn hàng mới"><i class="fa fa-plus" ></i> <span>Thêm đơn hàng</span></button> -->
	...
	<div class="col-lg-12">
		<div class="panel panel-no-border">
			<div class="table-responsive">
				...
				<?php if($fun == "canhan"){ ?>
					 <table class="table table-no-border table-ol-3w table-hover danhsachdonhangcanhan" id="danhsachdonhangcanhan">
						<thead>
						...
						<tbody class="taplet">
							<tr class="bangkhachhang">
							 ...
							 <option   value="Đang giao hàng" data-image="<?= HOME_URL;?>/images/xanh.png">Đang giao hàng</option>
							      <option value="Chưa thanh toán" data-image="<?= HOME_URL;?>/images/lacay.png" name="cd">Chưa thanh toán</option>
							    </select>
								...
								<select  class=" form-control sectcustum3 set1">
								  ...
								  <option value="Đang giao hàng" selected="selected">Nhân</option>
								  <option value="Chưa thanh toán">Hòa</option>
							...
							<tr class="bangkhachhang">
								...
								<select name="tech" class="tech form-control sectcustum1" id="tech2" style="padding-left: 20px;">
							     <option   value="Đang giao hàng" data-image="<?= HOME_URL;?>/images/xanh.png">Đang giao hàng</option>
							      <option value="Chưa thanh toán" data-image="<?= HOME_URL;?>/images/lacay.png" name="cd">Đợi thanh toán</option>
							    </select>

							    <div class="aotuonga">
							    <button class="btn btn-round color-1 material-design themmoiphieulap" type="button" name="login_admin" data-color="#004740" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Lưu ảnh màng hình" onclick="savescreen()"><i class="fa fa-plus-circle keyfram" ></i> <span>Insert</span></button>
                                </div>
                                </div>
					...
					<table class="table table-no-border table-ol-3w table-hover danhsachdonhangcanhan">
						<thead>
						...
						<tbody class="taplet">
							...
							<tr class="bangkhachhang">
								...
								<td>
								<select name="tech" class="tech form-control sectcustum1" id="tech1" style="padding-left: 20px;">  <option   value="Đang thiết kế" data-image="<?= HOME_URL;?>/images/xanh.png">Đang thiết kế</option>
							      <option selected="selected" value="Cho xuất kẽm" data-image="<?= HOME_URL;?>/images/lacay.png" name="cd">Cho xuất kẽm</option>  </select>
								</td>
								<td>
								<div class="imea">
							...
							<tr class="bangkhachhang">
							    ...
							    <div class="aotuonga">
							    <button class="btn btn-round color-1 material-design themmoiphieulap" type="submit" name="login_admin" data-color="#004740"><i class="fa fa-plus-circle keyfram" ></i> <span>Insert</span></button>
                                </div>
							  ...
							  <option   value="Đang giao hàng" data-image="<?= HOME_URL;?>/images/xanh.png">Đang giao hàng</option>
								...
								<select  class=" form-control sectcustum3 set1">
								  <option value="calendar">&nbsp;</option>
								  <option value="Đang giao hàng" >Nhân</option>
								  <option value="Chưa thanh toán">Hòa</option>
							  ...
							  <option   value="Đang giao hàng" data-image="<?= HOME_URL;?>/images/xanh.png">Đang giao hàng</option>
								...
								<select  class=" form-control sectcustum3 set1">
								  <option value="calendar">&nbsp;</option>
								  <option value="Đang giao hàng">Nhân</option>
								  <option value="Chưa thanh toán" selected="selected">Hòa</option>
								  <option value="email">Thức</option>
								  <option value="faq">Toàn</option>
								  <option value="email">Duyên</option>
								  <option value="faq">Hà</option>
...
function doitrangthai() {
	$("select.tech").change(function(e) {
		...
		var tiude = $(this).parent().parent().parent().find('.tiude').html();
		
		var han = 'Đơn hàng ' + tiude + ' : đã được chuyển sang ' + trangthai;
		$.ajax({
				url:'/action.php',
				type: 'POST',
				data: 'url=insert_message_notification_chuyen&content='+han ,
